...
class nTune():
  ...
  def checkValidCommon(self):
    ...
    if self.checkValue("steerRatio", 10.0, 20.0, 17.35):
      updated = True
  ...
  def checkValidLQR(self):
    ...
    if self.checkValue("dcGain", 0.002, 0.004, 0.00275):
      updated = True

    if self.checkValue("steerLimitTimer", 0.5, 3.0, 1.3):
      updated = True
  ...
  def checkValidISCC(self):
    ...
    if self.checkValue("sccGasFactor", 0.5, 1.5, 0.95):
      updated = True
